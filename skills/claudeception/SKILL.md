...
### Step 1: Search RBrain for Existing Knowledge
...
### Step 6: Capture to RBrain

After creating the skill, save it to RBrain so future sessions can find it:
...
- [ ] RBrain searched before creating
- [ ] RBrain captured after creating
...
**Step 1 - Search RBrain**: `search_thoughts("n8n workflow API tags read-only")`
No match found.
