...
# Sources shell profile for API keys, then cd into the brain repo so Bun
# auto-loads brain/.env (Bun's auto-load is CWD-based; without this, users
# who keep secrets in brain/.env see silent embed failures).
